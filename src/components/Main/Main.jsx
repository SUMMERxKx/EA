...
const Main = () => {
  const prompt1 = "Who are Electronic Arts?";
  const prompt2 = "Key Features of Electronic Arts";
  const prompt3 = "Aim of Electronic Arts";
  const prompt4 = "History of Electronic Arts";
      ...
      {!showResult ? (
        <>
          <div className="greet">
              ...
              <p>Welcome to Electronic Arts ChatBot</p>
          </div>
          <div className="cards">
